...
<div id = "detail">
	...
	<div style="margin-left: 500px;">
		<div class="inline"><a href="changePass.php?id=<?php echo $user['id']?>"><button class="button">Đổi mật khẩu</button></a></div>
		<div class="inline"><a href="edit.php?id=<?php echo $user['id']?>"><button class="button">Chỉnh sửa</button></a></div>
	</div>
<?php endif;?>
<?php endif;?>
<?php else:?>
